...
function pspdweb(req, res, next){
  ...
  function accept_oracle_data(data){
    try {
      ...
      if (cLen && cLen > cfg.zip_threshold && ohdr['Content-Encoding'] === undefined) {
        ohdr['Content-Encoding'] = 'gzip';
      }

      if (ohdr['Content-Encoding'] === 'gzip' && (compress = chooseZip(req)())) {
