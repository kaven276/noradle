var cfg = require('./cfg.js')
  ...
  , c
  , ports = require('./monitor.js').ports
  ;
...
exports.start_dynamic = function(handler){
  require('http').createServer(handler).listen(http_port, function(){
  ...
  require('https').createServer(options, handler).listen(https_port, function(){
