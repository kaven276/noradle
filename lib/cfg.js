...
module.exports = {
  ...
  x$prog2 : '', // default servlet name for url "/xxx/?"
  x$prog3 : '', // default servlet name for url "/xxx/xxx/xxx/?"
  u$location : '', // if parent path sect before x$prog is also miss, redirect to this url
  y$before : 'k_filter.before',
  y$after : 'k_filter.after',
  y$static : './', // default static url root
  t$timespan : 'N', // if trace timespan for steps of a reqeust, producing timespan
