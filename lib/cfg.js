...
module.exports = {
  ...
  oracle_timeout : 600, // seconds, after idle timeout, close connection, wait for ogw to reconnect
  oracle_keep_alive : 1 * 60 * 60, // seconds, keep alive to hod NAT state
  ...
  static_url : path.join(__dirname, '../static/'),
