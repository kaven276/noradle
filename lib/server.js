var sysCfg = require('./cfg.js')
  ...
  , mergeAdd = require('./util.js').mergeAdd
  ...
  , MD5CalcFilter = require('./MD5Calc.js')
  , ResultSetsFilter = require('./ResultSetsFilter.js')
  ...
  , ensureSid = require('./ensureSID.js')
  ;
  ...
  function pspdweb(req, res, next){
    ...
    switch (rb.x$prog) {
      ...
      default:
        ...
        console.log(rb.x$dbu, rb.x$dbu.search('.'));
