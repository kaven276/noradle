...
function ReqBase(r){
  ...
  me.url = r.url;
  me.caddr = r.connection.remoteAddress;
  me.cport = r.connection.remotePort;
  me.bsid = null;
  me.msid = null;
}
ReqBase.prototype.setSid = function(bsid, msid){
  this.bsid = bsid;
  this.msid = msid;
};
ReqBase.prototype.toOraLines = function(){
  var a = this;
  return [a.method, a.url, a.host, a.hostp, a.port, a.base, a.dad, a.prog, a.pack, a.proc, a.path, a.search, a.caddr, a.cport, a.bsid, a.msid].join(CRLF);
};
