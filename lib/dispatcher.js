...
// todo: client_cfgs should be in a configuration json file
// then can be CHAP code later to protect pasword transfer
...
exports.start = function(cfg){
  ...
  exports
    .listenOracle(cfg.oracle_port)
    .listenClient(cfg.client_port)
    .setKeepAlive(cfg.keep_alive_interval)
  ;
};

exports.listenOracle = function(port){
  exports.server4oracle.listen(port, function(){
...
exports.listenClient = function(port){
  exports.server4node.listen(port, function(){
...
(function(){
  ...
  exports.start({
    oracle_port : 9008,
    client_port : 9009,
    keep_alive_interval : 280,
    client_config : '../test/dispatcher/client_cfg.js'
  });
})();
